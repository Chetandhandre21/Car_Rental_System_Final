...
public class Rent_a_car extends javax.swing.JFrame {
    ...
    public void LoadCarid()
    {
        try {
            ...
            java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/car_rental_db_final", "root", "");
...
//                jTextField4.setText(aval.trim());
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER)
        {
            ...
            try {
                Class.forName("java.sql.Driver");
                java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/car_rental_db_finalr", "root", "");
